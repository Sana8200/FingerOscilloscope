...
#include "delay.h"
/*
 * Frequency (de10-lite DTEK-V) = 30 MHZ (30,000,000 cycles/second) : Period(1 cycle) = 1 / 30000000 = 33.33 ns
...
// Delay for approximately the specified number of microseconds => At 30 MHz: 1 µs = 30 cycles 
...
/**
 * Delay for approximately the specified number of nanoseconds => At 30 MHz: 1 cycle = 33.33 ns 
